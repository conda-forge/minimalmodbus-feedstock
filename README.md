...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/minimalmodbus-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8547&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/minimalmodbus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `minimalmodbus` can be installed with:

```
conda install minimalmodbus
```

It is possible to list all of the versions of `minimalmodbus` available on your platform with:
